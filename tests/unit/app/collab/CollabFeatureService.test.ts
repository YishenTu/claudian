...
function pendingRelocation() {
  return {
    ...
    newAuthority: {
      bindingVersion: 7,
      gitRemoteUrl: 'https://new.example.test/v7/projects/project-alpha/repository.git',
      serverUrl: 'https://new.example.test/',
      wireVersion: 11,
    },
    oldAuthority: {
      bindingVersion: 7,
      gitRemoteUrl: 'https://old.example.test/v7/projects/project-alpha/repository.git',
