...
function record() {
  return {
    ...
    newAuthority: {
      bindingVersion: 7,
      gitRemoteUrl: 'http://new.example.test/operator/v3/v7/projects/project-cloud/repository.git',
      serverUrl: 'http://new.example.test/operator/v3',
      wireVersion: 11,
    },
    oldAuthority: {
      bindingVersion: 7,
      gitRemoteUrl: 'https://old.example.test/root/v7/projects/project-cloud/repository.git',
