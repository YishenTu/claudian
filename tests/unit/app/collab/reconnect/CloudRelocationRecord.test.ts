...
function record() {
  return {
    ...
    newAuthority: {
      bindingVersion: 9,
      gitRemoteUrl: 'http://new.example.test/operator/v3/v9/projects/project-cloud/repository.git',
      serverUrl: 'http://new.example.test/operator/v3',
      wireVersion: 13,
    },
    oldAuthority: {
      bindingVersion: 9,
      gitRemoteUrl: 'https://old.example.test/root/v9/projects/project-cloud/repository.git',
