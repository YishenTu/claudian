...
function record() {
  return {
    ...
    newAuthority: {
      bindingVersion: 8,
      gitRemoteUrl: 'http://new.example.test/operator/v3/v8/projects/project-cloud/repository.git',
      serverUrl: 'http://new.example.test/operator/v3',
      wireVersion: 12,
    },
    oldAuthority: {
      bindingVersion: 8,
      gitRemoteUrl: 'https://old.example.test/root/v8/projects/project-cloud/repository.git',
