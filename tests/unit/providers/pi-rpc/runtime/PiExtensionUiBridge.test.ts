import { PiExtensionUiBridge, type PiExtensionUiRenderer } from '@/providers/pi-rpc/runtime/PiExtensionUiBridge';
import type { PiRpcTransport } from '@/providers/pi-rpc/runtime/PiRpcTransport';
...
describe('PiExtensionUiBridge', () => {
  ...
  it('cancels dialog requests when no renderer is available', () => {
    ...
    const bridge = new PiExtensionUiBridge(transport, null, 'Pi');
