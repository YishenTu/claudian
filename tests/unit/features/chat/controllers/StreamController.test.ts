...
jest.mock('@/features/chat/rendering', () => {
  return {
    ...
    appendFlavorThinkingContent: jest.fn(),
    appendThinkingContent: jest.fn(),
    createAsyncSubagentBlock: jest.fn().mockReturnValue({}),
    createFlavorThinkingBlock: jest.fn().mockReturnValue({
      wrapperEl: {
      ...
      flavorEl: {},
      hintEl: { setText: jest.fn() },
      contentEl: {},
      timerEl: { setText: jest.fn() },
      flavorText: 'Thinking...',
      thinkingContent: '',
    ...
    finalizeFlavorThinking: jest.fn().mockReturnValue(0),
