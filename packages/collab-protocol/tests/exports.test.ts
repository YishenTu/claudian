...
const EXPECTED_TYPE_EXPORTS = [
  ...
  'CollabControlOperation', 'CollabControlOperationCodec',
  ...
  'CollabTicketComment', 'CollabTicketCommentId', 'CollabTicketCommitRelationKind',
  ...
  'GetTicketRequest', 'ListTicketsRequest', 'TicketMutationResponse',
