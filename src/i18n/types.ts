...
export type TranslationKey =
  ...
  // Chat - Thinking Budget
  | 'chat.thinkingBudget.label'
  | 'chat.thinkingBudget.off'
  | 'chat.thinkingBudget.low'
  | 'chat.thinkingBudget.medium'
  | 'chat.thinkingBudget.high'
  | 'chat.thinkingBudget.ultra'
  
  // Chat - Greetings
  | 'chat.greetings.happySunday'
  | 'chat.greetings.sundaySession'
  | 'chat.greetings.welcomeWeekend'
  | 'chat.greetings.happyMonday'
  | 'chat.greetings.backAtIt'
  | 'chat.greetings.happyTuesday'
  | 'chat.greetings.happyWednesday'
  | 'chat.greetings.happyThursday'
  | 'chat.greetings.happyFriday'
  | 'chat.greetings.fridayFeeling'
  | 'chat.greetings.happySaturday'
  | 'chat.greetings.goodMorning'
  | 'chat.greetings.coffeeTime'
  | 'chat.greetings.goodAfternoon'
  | 'chat.greetings.heyThere'
  | 'chat.greetings.howsItGoing'
  | 'chat.greetings.goodEvening'
  | 'chat.greetings.evening'
  | 'chat.greetings.howWasYourDay'
  | 'chat.greetings.nightOwl'
  | 'chat.greetings.howAreYou'
  | 'chat.greetings.welcomeBack'
  | 'chat.greetings.whatsNew'
  | 'chat.greetings.youAreRight'
