...
export type TranslationKey =
  ...
  | 'settings.usageLimitsResetDisplay.name'
  | 'settings.usageLimitsResetDisplay.desc'
  | 'settings.usageLimitsResetDisplay.optionRemaining'
  | 'settings.usageLimitsResetDisplay.optionAbsolute'
