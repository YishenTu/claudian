...
- Surface close/disable/unload cancels presentation waits, not possible durable Cloud effects. Recovery observes the same application-owned intent; stale completions cannot reopen UI.
