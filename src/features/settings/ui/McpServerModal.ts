...
export class McpServerModal extends Modal {
  ...
  onOpen() {
    ...
    this.modalEl.addClass('geminian-mcp-modal');
    ...
    this.typeFieldsEl = contentEl.createDiv({ cls: 'geminian-mcp-type-fields' });
    this.renderTypeFields();
    ...
    const buttonContainer = contentEl.createDiv({ cls: 'geminian-mcp-buttons' });
  ...
  private renderStdioFields() {
    ...
    cmdSetting.settingEl.addClass('geminian-mcp-cmd-setting');

    const cmdTextarea = cmdSetting.controlEl.createEl('textarea', {
      cls: 'geminian-mcp-cmd-textarea',
    });
    ...
    envSetting.settingEl.addClass('geminian-mcp-env-setting');

    const envTextarea = envSetting.controlEl.createEl('textarea', {
      cls: 'geminian-mcp-env-textarea',
    });
  ...
  private renderUrlFields() {
    ...
    headersSetting.settingEl.addClass('geminian-mcp-env-setting');
